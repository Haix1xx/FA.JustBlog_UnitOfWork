...
namespace FA.JustBlog.Core.Migrations
{
    ...
    [Migration("20240121150422_UpdateUser")]
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CommentTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(3970));
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            Modified = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9710),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            Modified = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9727),
                            PostContent = "This is an post content",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            Modified = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9735),
                            PostContent = "This is an post content",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            Modified = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9741),
                            PostContent = "This is an post content",
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            Modified = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9745),
                            PostContent = "This is an post content",
                            PostedOn = new DateTime(2024, 1, 21, 22, 4, 22, 154, DateTimeKind.Local).AddTicks(9744),
                            Published = true,
